			...
			<section id="main">
				...
				<ul class="item-list">
					<li>
						<div class="item">
							<div class="image">
								<img src="images/dessert-item-01.jpg"  alt="" />
								<div class="hover">
					...
					<li>
						<div class="item">
							<div class="image">
								<img src="images/dessert-item-02.jpg"  alt="" />
								<div class="hover">
									<div class="item-content" style="text-align:center;width:1200px; height:340px;">
					...
					<li>
						<div class="item">
							<div class="image">
								<img src="images/dessert-item-03.jpg"  alt="" />
								<div class="hover">
									<div class="item-content" style="text-align:center;width:1200px; height:340px;">
					...
					<li>
						<div class="item">
							<div class="image">
								<img src="images/dessert-item-04.jpg"  alt="" />
								<div class="hover">
									<div class="item-content" style="text-align:center;width:1200px; height:220px;">
