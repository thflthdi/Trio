							...
							<div class="image">
								...
								<div class="hover">
									<div class="item-content" style="text-align:center;width:1200px; height:220px;">
										<a href="cart.jsp" id="s-01" class="btn white normal">Add to cart</a>
										<a href="singleproduct.jsp" id="s-01" class="btn white normal">See details</a>
									</div>
									<span class="bg"></span>
								</div>
							</div>
					...
					<li>
						<div class="item">
							<div class="image">
								...
								<div class="hover">
									<div class="item-content" style="text-align:center;width:1200px; height:220px;">
										<a href="cart.jsp" id="s-06" class="btn white normal">Add to cart</a>
										<a href="singleproduct.jsp" id="s-06" class="btn white normal">See details</a>
									</div>
									<span class="bg"></span>
								</div>
							</div>
					...
					<li>
						<div class="item">
							<div class="image">
								...
								<div class="hover">
									<div class="item-content" style="text-align:center;width:1200px; height:220px;">
										<a href="cart.jsp" id="s-02" class="btn white normal">Add to cart</a>
										<a href="singleproduct.jsp" id="s-02" class="btn white normal">See details</a>
									</div>
									<span class="bg"></span>
								</div>
							</div>
					...
					<li>
						<div class="item">
							<div class="image">
								...
								<div class="hover">
									<div class="item-content" style="text-align:center;width:1200px; height:220px;">
										<a href="cart.jsp" id="s-03" class="btn white normal">Add to cart</a>
										<a href="singleproduct.jsp" id="s-03" class="btn white normal">See details</a>
									</div>
									<span class="bg"></span>
								</div>
							</div>
					...
					<li>
						<div class="item">
							<div class="image">
								...
								<div class="hover">
									<div class="item-content" style="text-align:center;width:1200px; height:220px;">
										<a href="cart.jsp" id="s-04" class="btn white normal">Add to cart</a>
										<a href="singleproduct.jsp" id="s-04" class="btn white normal">See details</a>
									</div>
									<span class="bg"></span>
								</div>
							</div>
					...
					<li>
						<div class="item">
							<div class="image">
								...
								<div class="hover">
									<div class="item-content" style="text-align:center;width:1200px; height:220px;">
										<a href="cart.jsp" id="s-05" class="btn white normal">Add to cart</a>
										<a href="singleproduct.jsp" id="s-05" class="btn white normal">See details</a>
									</div>
									<span class="bg"></span>
								</div>
							</div>
